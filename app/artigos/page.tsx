  ...
  React.useEffect(() => {
    ...
    if (saved) {
      ...
      const initial = [
        ...
        { id: 7, tag: 'Fitoterapia', title: 'Ashwagandha: O Ginseng Indiano', resumo: 'A erva adaptógena mais famosa e seus reais benefícios clínicos.', imagem: 'https://images.unsplash.com/photo-1594824406951-31823095b27b?q=80&w=600&auto=format&fit=crop', status: 'Publicado' },
