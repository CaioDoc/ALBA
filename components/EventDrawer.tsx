    ...
    <>
      ...
      <div className={`fixed top-0 right-0 h-full w-full max-w-md bg-white z-[70] shadow-2xl transform transition-transform duration-500 ease-out flex flex-col ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className="p-6 bg-white border-t border-stone-100">
          <Link 
            href="/associe-se"
            className="w-full bg-emerald-800 text-white py-4 rounded-xl font-bold hover:bg-emerald-900 transition-all cursor-pointer flex justify-center items-center"
          >
            Inscrever-se Agora
          </Link>
        </div>
