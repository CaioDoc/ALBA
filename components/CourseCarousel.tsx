...
const coursesData: Course[] = [
  ...
  { id: 2, title: 'Workshop Indian Head Massage - Champi', category: 'Workshop Prático', workload: 'Consulte', format: 'Presencial', image: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=600&auto=format&fit=crop', date: 'Em Breve', description: 'Aprenda a tradicional técnica indiana de massagem focada na cabeça, ombros e pescoço.', price: 'Consulte' },
  { id: 3, title: 'Instrutor de Yoga - Formação Super Intensiva', category: 'Formação Intensiva', workload: 'Consulte', format: 'Imersão', image: '/images/artigos/medicina_ayurv_dica___um_sistema_de_cura_hol_stica.jpg', date: 'Em Breve', description: 'Imersão profunda e transformadora para formação certificada de instrutores de Yoga.', price: 'Consulte' },
